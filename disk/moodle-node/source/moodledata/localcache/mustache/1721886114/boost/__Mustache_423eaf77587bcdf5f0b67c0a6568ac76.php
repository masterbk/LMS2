...
class __Mustache_423eaf77587bcdf5f0b67c0a6568ac76 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<div class="divider border-left h-75 align-self-center ml-1 mr-1"></div>
';
...
';
        $buffer .= $indent . '        <label class="mr-2 mb-0 hidden-lg ';
