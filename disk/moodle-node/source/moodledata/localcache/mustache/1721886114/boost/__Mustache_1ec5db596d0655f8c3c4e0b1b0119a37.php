...
class __Mustache_1ec5db596d0655f8c3c4e0b1b0119a37 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section70e392a0fc12e87357d01b0bd29d3fe3($context, $indent, $value);
        $buffer .= $indent . '        <div>
';
        $buffer .= $indent . '            ';
...
';
    ...
    private function section70e392a0fc12e87357d01b0bd29d3fe3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '            <a class="h-100 d-flex align-items-center mr-2" href="#" data-route-back role="button">
';
