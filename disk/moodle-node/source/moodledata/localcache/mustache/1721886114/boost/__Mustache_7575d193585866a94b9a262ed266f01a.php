...
class __Mustache_7575d193585866a94b9a262ed266f01a extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'blockD1925ac2470d4e78065a15494378a762'),
            ));
...
';
    ...
    private function section6cefdf2578de57d31d1973526c3c0c12(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section2cb795740a88b20e6cf97b7857331abe(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section2374f91eca02d3454449c0489ebe6f3e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section2cb795740a88b20e6cf97b7857331abe($context, $indent, $value);
                $context->pop();
            }
        }
    ...
    private function sectionEe0e16fc00224e367a277381c844c4ae(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    public function blockD1925ac2470d4e78065a15494378a762($context)
    {
        $indent = $buffer = '';
        $value = $context->findDot('element.frozen');
        if (empty($value)) {
...
';
            $value = $context->findDot('element.options');
            $buffer .= $this->section6cefdf2578de57d31d1973526c3c0c12($context, $indent, $value);
            $buffer .= $indent . '        </select>
';
        }
        $value = $context->findDot('element.frozen');
        $buffer .= $this->section2374f91eca02d3454449c0489ebe6f3e($context, $indent, $value);
        $value = $context->findDot('element.managestandardtagsurl');
        $buffer .= $this->sectionEe0e16fc00224e367a277381c844c4ae($context, $indent, $value);
