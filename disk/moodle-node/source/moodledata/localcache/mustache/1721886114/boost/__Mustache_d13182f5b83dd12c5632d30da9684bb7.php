...
class __Mustache_d13182f5b83dd12c5632d30da9684bb7 extends Mustache_Template
{
...
';
        ...
        if ($parent = $this->mustache->loadPartial('core_message/message_drawer_view_contacts_body_section_contacts')) {
            $context->pushBlockContext(array(
                ...
                'rootattributes' => array($this, 'block917bfb7ed897403e85ac43b0503c46d6'),
            ));
...
';
        ...
        if ($parent = $this->mustache->loadPartial('core_message/message_drawer_view_contacts_body_section_requests')) {
            $context->pushBlockContext(array(
                ...
                'rootattributes' => array($this, 'block2ad5257319ab6bb5fcbec8d930634889'),
            ));
            $buffer .= $parent->renderInternal($context, $indent);
            $context->popBlockContext();
        }
...
';
    ...
    public function block917bfb7ed897403e85ac43b0503c46d6($context)
    {
        $indent = $buffer = '';
...
';
    ...
    public function block2ad5257319ab6bb5fcbec8d930634889($context)
    {
        $indent = $buffer = '';
