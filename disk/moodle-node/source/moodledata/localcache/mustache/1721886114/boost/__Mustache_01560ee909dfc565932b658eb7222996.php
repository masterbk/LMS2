...
class __Mustache_01560ee909dfc565932b658eb7222996 extends Mustache_Template
{
...
';
        ...
        if ($parent = $this->mustache->loadPartial('core_message/message_drawer_lazy_load_list')) {
            $context->pushBlockContext(array(
                'rootclasses' => array($this, 'blockE2d8d68efaf85f7d5a6d515e28a68f6d'),
                'rootattributes' => array($this, 'block8fda84b501b63ab62c3dd73de2aaaae8'),
            ));
...
';
    ...
    public function blockE2d8d68efaf85f7d5a6d515e28a68f6d($context)
    {
        $indent = $buffer = '';
    ...
    public function block8fda84b501b63ab62c3dd73de2aaaae8($context)
    {
        $indent = $buffer = '';
        $buffer .= '            id="';
        $blockFunction = $context->findInBlock('region');
