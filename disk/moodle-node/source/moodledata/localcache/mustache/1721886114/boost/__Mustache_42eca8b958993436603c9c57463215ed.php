...
class __Mustache_42eca8b958993436603c9c57463215ed extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block57dcffbcb9786771bb8c6e8efb090e45'),
            ));
    ...
    private function section0bdc0a86032ef948f3226dd357291eff(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    public function block57dcffbcb9786771bb8c6e8efb090e45($context)
    {
        $indent = $buffer = '';
...
';
        $value = $context->find('error');
        $buffer .= $this->section0bdc0a86032ef948f3226dd357291eff($context, $indent, $value);
        $buffer .= $indent . '                        ';
