...
class __Mustache_476d6511648b96ff7507e51d2f335a5e extends Mustache_Template
{
...
';
        ...
        $value = $context->find('hasblocks');
        $buffer .= $this->sectionD91aa1cf62bda6d97a530353a3307fd0($context, $indent, $value);
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '            ';
...
';
        ...
        $buffer .= $this->sectionC8a5b23067a83c4d3fdddbb216b85f8d($context, $indent, $value);
...
';
        ...
        $buffer .= $this->sectionEbbbb62d807d9bece0fbcf5217d6e3e7($context, $indent, $value);
        $buffer .= $indent . '                        ';
            ...
            foreach ($values as $value) {
                ...
                if ($parent = $this->mustache->loadPartial('theme_boost/drawer')) {
                    $context->pushBlockContext(array(
                        ...
                        'drawercontent' => array($this, 'block2c063f8932580bc9780124ea42c05b83'),
            ...
            foreach ($values as $value) {
                ...
                if ($parent = $this->mustache->loadPartial('theme_boost/drawer')) {
                    $context->pushBlockContext(array(
                        ...
                        'drawercontent' => array($this, 'block26a218776be54005631772078d9bbd21'),
...
';
    ...
    private function sectionD91aa1cf62bda6d97a530353a3307fd0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionC8a5b23067a83c4d3fdddbb216b85f8d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionEbbbb62d807d9bece0fbcf5217d6e3e7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    public function block2c063f8932580bc9780124ea42c05b83($context)
    {
        $indent = $buffer = '';
        $buffer .= '                ';
...
';
    ...
    public function block26a218776be54005631772078d9bbd21($context)
    {
        $indent = $buffer = '';
