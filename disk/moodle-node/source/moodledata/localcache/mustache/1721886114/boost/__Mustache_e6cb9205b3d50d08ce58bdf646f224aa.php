...
class __Mustache_e6cb9205b3d50d08ce58bdf646f224aa extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section273cfc704e7e9c9c94fc4328320e6744($context, $indent, $value);
        $buffer .= '</ol>
';
        $buffer .= $indent . '</nav>
';
    ...
    private function section5b4d61bbb5365b184a0e6753c7e804be(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section273cfc704e7e9c9c94fc4328320e6744(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section5b4d61bbb5365b184a0e6753c7e804be($context, $indent, $value);
                $value = $context->find('has_action');
                if (empty($value)) {
