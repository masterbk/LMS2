...
class __Mustache_a6690bb000c2b5e0bd1acda29f909b5d extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block4a1207cd9051fc40ac48c1f916bfc721'),
            ));
...
';
    ...
    public function block4a1207cd9051fc40ac48c1f916bfc721($context)
    {
        $indent = $buffer = '';
