...
class __Mustache_de0d23f31a9d06f9efc23e24250c561e extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section9972f50fe4793ac34ef7987ac89eb72e($context, $indent, $value);
...
';
        $value = $context->find('showemojipicker');
        $buffer .= $this->section57d8979abfa38ec81afa48db17e6c639($context, $indent, $value);
...
';
    ...
    private function section9972f50fe4793ac34ef7987ac89eb72e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section57d8979abfa38ec81afa48db17e6c639(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
