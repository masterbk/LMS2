...
class course_edit_form extends moodleform {
    ...
    function definition() {
        ...
        // VTC tài liệu tham khảo
        $mform->addElement('header', 'referenceshdr', get_string('references', 'local_vtc'));
        $mform->setExpanded('referenceshdr');

        $mform->addElement(
            'filemanager',
            'references',
            get_string('references', 'local_vtc'),
            null,
            [
                'subdirs' => 0,
                'maxfiles' => 50,
