...
namespace format_vtc\output;

use core_courseformat\output\section_renderer;
use moodle_page;

/**
 * Basic renderer for vtc format.
 *
...
class renderer extends section_renderer {
    ...
    public function __construct(moodle_page $page, $target) {
        ...
        // Since format_vtc_renderer::section_edit_control_items() only displays the 'Highlight' control
    ...
    public function render_content() {
        ...
        echo $this -> render_from_template("format_vtc/local/content", $data);
    }
}
