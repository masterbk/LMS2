...
class core_course_editcategory_form extends moodleform {
    ...
    public function definition() {
        ...
        $showinmenunavbar = $this->_customdata['showinmenunavbar'];
        ...
        $fileoptions = array(
            ...
            'subdirs'        => 0,
            'accepted_types' => array('.png', '.jpg','jpeg', '.gif', '.webp', '.tiff', '.svg')
        );
        $mform->addElement('filemanager', 'categorypicture_filemanager', get_string('coursecategoryoverviewfiles'), null, $fileoptions);
        ...
        $mform->addElement('advcheckbox', 'showinmenunavbar', get_string('showinmenunavbardesc', 'theme_moove'));
        $mform->setDefault('showinmenunavbar',$showinmenunavbar);
