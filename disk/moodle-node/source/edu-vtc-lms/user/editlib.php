 ...
 * @param stdClass $user
 */
function vtc_useredit_shared_definition(&$mform, $editoroptions, $filemanageroptions, $user) {
    global $CFG, $USER, $DB;
...
//    }
    ...
    $mform->addElement('text', 'city', get_string('city'), 'maxlength="120" size="21" data-toggle="modal" data-target=".custom-signup-city"');
