...
$string['pluginname'] = 'Bulk Download Custom Certs';
$string['pluginname_help'] = 'Let you download all the Custom Certs from a course inside a zip file.';
$string['credit'] = 'Gonzalo Romero';
$string['bulkdownloadlink'] = 'Download All Certificates';
