...
$string['pluginname'] = 'Tải xuống tất cả chứng chỉ';
$string['pluginname_help'] = 'Cho phép bạn tải xuống tất cả Chứng chỉ từ một khóa học bên trong tệp zip.';
$string['credit'] = 'Gonzalo Romero';
$string['bulkdownloadlink'] = 'Tải xuống tất cả chứng chỉ';
