...
M.form_filemanager.init = function(Y, options) {
    ...
    Y.extend(FileManagerHelper, Y.Base, {
        ...
        initializer: function(options) {
            ...
            this.filepicker_options.groupId = (Math.random() + 1).toString(36).substring(6);
        ...
        getSelectedFiles: function() {
            var markedFiles = this.filemanager.all(`[data-togglegroup=file-selections-${this.filepicker_options.groupId}]:checked`);
            var filenames = [];
        ...
        view_files: function(appendfiles, actionfiles) {
            ...
            this.filemanager.one('.fp-content').set_group_id(this.filepicker_options.groupId);
