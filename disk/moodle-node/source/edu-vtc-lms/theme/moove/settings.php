...
if ($ADMIN->fulltree) {
    ...
    */
    ...
    // Raw SCSS to include after the content.
    $setting = new admin_setting_configtextarea('theme_moove/trainingfacilities', get_string('trainingfacilities', 'theme_moove'),
        get_string('trainingfacilities_desc', 'theme_moove'), '', PARAM_RAW);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);
    ...
    */
    ...
    // Phone url setting.
    $name = 'theme_moove/phone';
    $title = get_string('phone', 'theme_moove');
    $description = get_string('phonedesc', 'theme_moove');
    $setting = new admin_setting_configtext($name, $title, $description, '');
    $page->add($setting);


    // Email url setting.
    $name = 'theme_moove/email';
    $title = get_string('email', 'theme_moove');
    $description = get_string('emaildesc', 'theme_moove');
    $setting = new admin_setting_configtext($name, $title, $description, '');
    $page->add($setting);

    // Fax url setting.
    $name = 'theme_moove/fax';
    $title = get_string('fax', 'theme_moove');
    $description = get_string('faxdesc', 'theme_moove');
    $setting = new admin_setting_configtext($name, $title, $description, '');
    $page->add($setting);
