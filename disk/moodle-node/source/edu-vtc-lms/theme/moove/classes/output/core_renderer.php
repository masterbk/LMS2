...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    public function standard_head_html() {
        ...
        $output .= "<meta property=\"og:title\" content=\"{$this->page->title}\"/> \n";
        $output .= "<meta property=\"og:url\" content=\"https://edu.vtc.vn\" />";
        $output .= "<meta property=\"og:site_name\" content=\"{$this->page->title}\" /> \n";
        $output .= "<meta property=\"og:image\" content=\"https://edu.vtc.vn/theme/moove/public/video.jpg\"> \n";
    ...
    public function render_login(\core_auth\output\login $form) {
        ...
        if ($context->paramsubmit !== false) {
            if ($context->paramsubmit->username == '') {
                $context->paramsubmit->errorusername = get_string('userrequired', 'theme_moove');
            }
            if ($context->paramsubmit->password == '') {
                $context->paramsubmit->errorpassword = get_string('passwordrequired', 'theme_moove');
            }
            if($context->paramsubmit->username != '' && $context->paramsubmit->password != '') {
                $context->paramsubmit->errorlogin = get_string('invalidlogin', 'theme_moove');
            }
        }
        ...
        $context->publicimage = (new moodle_url('/theme/moove/public'))->out(false);

        return $this->render_from_template('core/login_form_layout', $context);
    }
    ...
    public function render_login_signup_form($form) {
        ...
        $context['publicimage'] = (new moodle_url('/theme/moove/public'))->out(false);
        $context['signupurl'] = (new moodle_url('/login/signup.php'))->out(false);
        $context['loginurl'] = (new moodle_url('/login/index.php'))->out(false);
        $context['session'] = sesskey();
        $context['listcity']= vtcLoadListCity($context);
